...
function gdprduAdminPage(){
	...
	$xbox->add_main_tab( array(
		...
		'items' => array(
			...
			'notification' => '<i class="xbox-icon xbox-icon-image"></i>GDPR Notification',
		),
	));
	...
	$xbox->add_field(array(
		...
		'desc' => __( 'Regarding GDPR guidelines, you as business/site owner have to inform visitors/customers about obtaining their data via ANY FORM and must get acceptance from visitors/customers.', 'gdpr-integration' ),
		'type' => 'switcher',
		'default' => 'off',
	));
	$xbox->add_field(array(
