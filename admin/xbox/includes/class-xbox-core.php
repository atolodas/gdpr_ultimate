...
class XboxCore {
	...
	*/
	public function add_tab( $field_args = array(), &$parent_object = null, $main_tab = false ){
		...
		return $main_tab ? $this->add_field( $field_args, $parent_object ) : '';
	}
	...
	*/
	public function exclude_field_type_for_save(){
		return array('title', 'tab', 'tab_item', 'mixed', 'section', 'import', 'export', 'html', 'button'  );
	}

	public function get_pro(){
		return '<a href="https://codecanyon.net/item/xbox-framework-create-meta-boxes-theme-options-admin-pages-for-wordpress/19250995" target="_blank">Get PRO Version</a>';
	}
