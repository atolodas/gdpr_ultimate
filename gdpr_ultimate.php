		...
		$( document ).ready(function() {
		    ...
		    $(form).each(function() {
		      if($(this).find('input:text')){
		     	$(this).find('button').before('<label class="row" style="margin:5px auto; clear:both;display: block;"><span style="float:left;"><?php echo $checkbox_label; ?></span><input name="gdrp" id="gdrpcheckbox" value="1" type="checkbox" required></label>');
							$(this).find('input:submit').before('<label class="row" style="clear:both;display: table;"><span style="float:left;">By checking this checkbox you agree with the storage and handling of your data by this website.<input style="margin-left:18px;" name="gdrp" id="gdrpcheckbox" value="1" type="checkbox" required></span></label>');
					}
		    });
		});
		</script>
